...
## Correr ambiente de Strapi en 'dev'

1. Correr servidor para Stripe con `stripe listen --forward-to localhost:3000/api/webhook` a la par que el servidor de Next JS y pega a las variables de desarrollo el siguiente Webhook signing secret.
